      ...
      <div className="about-container">
        <div className="about-content slide-in">
          ...
          <p className="about-text">
            ...
            documentaries, and content creation, we have established ourselves
            as a leading player in the Nigerian entertainment industry.
          </p>
          <p className="about-text">
            Our portfolio includes the highly successful Yawaskits YouTube
            channel, one of Nigeria's most recognized and beloved channels with
            an impressive following of over 6 million subscribers across all
